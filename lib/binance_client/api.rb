...
module BinanceClient
  class API
    ...
    def place_take_profit(symbol:, side:, quantity:, stop_price:, price:)
      place_order(symbol: symbol, side: side.to_s.upcase, type: 'TAKE_PROFIT', price: price.to_s.to_f, quantity: quantity, stopPrice: stop_price)
    end
